...
public interface OrderDetailRepository extends CrudRepository<OrderDetail, Integer> {
	...
	@Query("SELECT NEW com.tma.vlhau.ecommercecommon.entity.order.OrderDetail(d.product.category.name, d.quantity,"
    ...
    @Query("SELECT NEW com.tma.vlhau.ecommercecommon.entity.order.OrderDetail(d.quantity, d.product.name,"
