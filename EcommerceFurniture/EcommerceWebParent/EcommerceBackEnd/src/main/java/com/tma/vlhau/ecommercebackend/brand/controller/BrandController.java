...
import com.tma.vlhau.ecommercebackend.brand.exporter.BrandCSVExporter;
...
public class BrandController {
    ...
    public String saveBrand(@Valid Brand brand, BindingResult bindingResult, RedirectAttributes redirectAttributes,
