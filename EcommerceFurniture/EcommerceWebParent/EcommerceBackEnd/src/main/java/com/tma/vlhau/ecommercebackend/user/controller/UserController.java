...
import com.tma.vlhau.ecommercebackend.user.exporter.UserCSVExporter;
...
import com.tma.vlhau.ecommercecommon.entity.UserDTO;
...
public class UserController {
    ...
    public String saveUser(@Valid User user, BindingResult bindingResult, RedirectAttributes redirectAttributes, @RequestParam("image") MultipartFile multipartFile, Model model) throws IOException {
    ...
    @PostMapping("/users/saveEdit")
    public String saveUserEdit(UserDTO userDTO, RedirectAttributes redirectAttributes) {
